    ...
    return (
        <div>
            ...
            {props.isBartenderHoursClicked === false ? (
                ...
                <FormGroup row>
                    <Col >
                        <Label className="sub-heading" sm={12}>Bartenders</Label>
                    </Col>
                    <Col >
                        <Label className="sub-heading" sm={12}>Hours</Label>
                    </Col>
                    <Col >
                        <Label className="sub-heading" sm={12}>Credit Card Tips</Label>
                    </Col>
                ...
                {props.workingBartender.map((bartender, i) => (
                    <div>
                        ...
                        <FormGroup row key={i}>
                            <Col>
                                <Label className="align-name" sm={12} >{bartender}</Label>
                            </Col>
